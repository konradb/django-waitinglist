...
There are many ways you can help contribute to django-waitinglist and the
...
When writing code to be included in django-waitinglist keep our style in mind:
